...
export const article = {
  author: 'Daniel Smith',
  date: '2026-03-02',
  title: 'Example Title: Examples Shown as Examples',
  description:
    'When you’re building an example for use as an example, you need to make a good example. For example our website and featured examples.',
}
...
To make this example, we needed to squeeze every drop of performance out of the example. And so the example was born.
